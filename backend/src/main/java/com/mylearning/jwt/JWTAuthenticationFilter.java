...
import com.mylearning.Student.StudentUserDetailService;
...
public class JWTAuthenticationFilter extends OncePerRequestFilter {
    ...
    public JWTAuthenticationFilter(JWTUtil jwtUtil, StudentUserDetailService studentUserDetailService){
            ...
            @NonNull FilterChain filterChain) throws ServletException, IOException
    {
        ...
        {
            UserDetails   userDetails = studentUserDetailService.loadUserByUsername(subject);
